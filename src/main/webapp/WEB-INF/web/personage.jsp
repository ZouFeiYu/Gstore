...
<body>
	...
	<header id="top" class="fixed_nav">
		...
		<div class="rt">
			<ul class="lf">
				...
				<li><a
					href="${pageContext.request.contextPath}/${sessionScope.onLineUser.id}/personage.page">${sessionScope.onLineUser.userName}</a><b>|</b></li>
				<li><a href="logout.do" title="退出后,下次将不再自动登录">退出</a></li>
			</ul>
		</div>
	</header>
	<!-- nav主导航-->
	<nav id="nav">
		<ul>
			<li><a href="index.page" class="acti">首页</a></li>
			<li><a href="index.page#computer">电脑办公</a></li>
			<li><a href="index.page#stationery">办公文具</a></li>
		</ul>
	</nav>
	<!-- 我的订单导航栏-->
	<div id="nav_order">
		...
		<div class="rightsidebar_box rt">
			...
			<div class="rs_content">
				...
				<div class="rs_content_tel">
					<span class="same">绑定电话：</span> <input name="phone" type="text"
	...
	$('.ed_email')
			.blur(
					function() {
						...
						var patrm = /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(\.[a-zA-Z0-9_-])$/;
