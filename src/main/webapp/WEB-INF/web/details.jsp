...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="${pageContext.request.contextPath}${good.image }"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
                <li class="i1"><img src="${pageContext.request.contextPath}${good.image}"/></li>
            </ul>
        </div>
    </div>
    <!-- 右侧-->
    <div class="right_detail lf" id='${good.id }'>
        <!-- 商品名称-->
        <h1>${good.itemType }</h1>
        <!-- 商品全称-->
        <h3>${good.title }</h3>
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>学员售价：</b><span>${good.price }</span></div>
            <div class="promise">
                <b>服务承诺：</b>
                <span>*退货补运费</span>
                <span>*30天无忧退货</span>
