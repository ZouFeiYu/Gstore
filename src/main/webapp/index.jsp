...
<body>
	...
	<header id="top">
		<div class="top">
			<img src="${pageContext.request.contextPath}/images/header/logo.png" alt="" /> <span>页面索引</span>
		</div>
	</header>
	<div id="container">
		<div id="cover" class="rt">
			<ul>
				<li><a href="${pageContext.request.contextPath}/web/view/login">登录页 login.html</a></li>
				<li><a href="${pageContext.request.contextPath}/web/view/index">首页 index.html</a></li>
				<li><a href="${pageContext.request.contextPath}/web/view/register">注册 register.html</a></li>
				<li><a href="${pageContext.request.contextPath}/web/view/404">404错误 404.html</a></li>
				<li><a href="${pageContext.request.contextPath}/web/view/500">500错误 500.html</a></li>
				<li><a href="${request.contextPath}/Gstore.file/Project.zip">下载全部资料 pages.zip</a></li>
			</ul>
		</div>
	</div>
	<!-- 页面底部-->
