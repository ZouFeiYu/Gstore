...
$('.seek').focus(function(){
    ...
    if($(this).hasClass('clickhover')){
        ...
        $(this).find('img').attr('src',$('#basePath').val()+'/images/header/header_normal.png');

    }else{
        $(this).addClass('clickhover');
        $(this).find('.seek_content').show();
        $(this).find('img').attr('src',$('#basePath').val()+'/images/header/header_true.png');
    }
})
$('.seek_content>div').click(function(){
    ...
    $('.seek span').html(text);
    $(this).parent().hide();
    $('.seek').find('img').attr('src',$('#basePath').val()+'/images/header/header_normal.png');
    $('.seek').blur();
