$(function() {
	...
	$(".all").click(function() {
		...
		if($('.all>span').hasClass('normal')){
			...
			$('.all>span>img').attr('src',$('#basePath').val()+'/images/cart/product_true.png');
			$(".Each>span").each(function() {
				$(this).addClass('true').removeClass('normal');
				$(this).children('img').attr('src',$('#basePath').val()+'/images/cart/product_true.png');
			})

			totl();
		}else{
			$('.all>span').addClass('normal').removeClass('true');
			$('.all>span>img').attr('src',$('#basePath').val()+'/images/cart/product_normal.png');
			$('.Each>span').addClass('normal').removeClass('true');
			$('.Each>span>img').attr('src',$('#basePath').val()+'/images/cart/product_normal.png');
			$(".susum").text(0.00);
			$(".susumOne").text(0.00);
			$('.total').text(0);
			$('.totalOne').text(0);
	...
	$('.Each>span').click(function(){
		...
		if($(this).hasClass('normal')){
			...
			$(this).children('img').attr('src',$('#basePath').val()+'/images/cart/product_normal.png');
			var amou=parseInt($('.total').text());
			amou--;
			$('.total').text(amou);
			$('.totalOne').text(amou);
