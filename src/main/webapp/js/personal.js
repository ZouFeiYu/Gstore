...
$(".man").click(function(){
	if(!$(".man").hasClass("selected")){
		...
		$(".man img").attr("src",$('#basePath').val()+"/images/personage/select.png");
		$(".women").removeClass("selected");
		$(".women img").attr("src",$('#basePath').val()+"/images/personage/un_select.png");
	}
})
...
$(".women").click(function(){
	if(!$(".women").hasClass("selected")){
		...
		$(".women img").attr("src",$('#basePath').val()+"/images/personage/select.png");
		$(".man").removeClass("selected");
		$(".man img").attr("src",$('#basePath').val()+"/images/personage/un_select.png");
	}
})
/**
 * 更改用户名，变成可编辑状态
